...
def gen_train_data(dataset, split, time_step, nb_nodes, nhood, global_att, batch_size, view='', reverse='0', D=False):
	...
	if not D:
		...
		return 0, X_train_P, X_train_B, X_train_H_B, 0, y_train, D_13_train, D_16_train,\
		       X_test_J, X_test_P, X_test_B, X_test_H_B, 0, y_test, D_13_test, D_16_test, \
		       0, 0, adj_part, biases_part, adj_body, biases_body, adj_hyper_body, biases_hyper_body, 0, 0, nb_classes
